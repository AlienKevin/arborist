...
extern "C" {
    pub fn SetupBenchmark(name: GoString);
}
extern "C" {
    pub fn LoadDoc(id: GoUint16);
}
extern "C" {
    pub fn QuerySelector(selector: GoString) -> GoUint8;
}
extern "C" {
    pub fn QuerySelectors(selectors: GoSlice) -> GoUint8;
}
